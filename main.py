...
question = (
    'Какое колесо не крутится при правом развороте?', 'Каких камней в море нет?',
    '''Существует анекдот про московских рэкетиров, которые пошли на дело, но по пути наткнулись на небольшое 
символическое "препятствие". На вопрос рэкетиров: "На кого работаешь" встреченное животное дало вполне логичный 
ответ. Какой?''', 'Как Настя записана у меня в телефоне?', 'Как в старину называли сторожа городских ворот?',
    'Железная дорога с канатной тягой, устраиваемая на крутых подьемах', 'Белый нагрудник на мужской сорочке?'
    )


word_list = ['Запасное', 'Сухих', 'Мур', 'Сласть', 'Вратарь', 'Фуникулер', 'Манишка']
